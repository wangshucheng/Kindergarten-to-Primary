...
export function GeometryGame({ sound, tts: ttsManager, onComplete }: GameProps) {
  ...
  // ---------------- 渲染：模式菜单 ----------------
  const menu = (
    <View className="grid grid-cols-3 gap-3 w-full max-w-md">
      {MODES.map((m) => (
        <View
          key={m.key}
  ...
  const header = (
    <View className="flex flex-wrap justify-center gap-2 w-full max-w-md">
      {MODES.map((m) => (
        <View
          key={m.key}
          onClick={() => setMode(m.key)}
  ...
  return (
    <View className="flex flex-col items-center gap-4 w-full max-w-md">
      ...
      <View className="w-full rounded-4xl bg-cream shadow-soft p-6 flex flex-col items-center gap-3">
        <View className="text-inkSoft text-sm">认一认</View>
...
function CountMode(deps: ModeDeps) {
  ...
  return (
    <View className="flex flex-col items-center gap-4 w-full max-w-md">
      <Hud idx={idx} score={deps.score} />
      <View className="w-full rounded-4xl bg-cream shadow-soft p-6 flex flex-col items-center gap-3">
        <View className="text-inkSoft text-sm">数一数，一共有几个正方体？</View>
...
function SymmetryMode(deps: ModeDeps) {
  ...
  return (
    <View className="flex flex-col items-center gap-4 w-full max-w-md">
      <Hud idx={idx} score={deps.score} />
      <View className="w-full rounded-4xl bg-cream shadow-soft p-6 flex flex-col items-center gap-3">
        <View className="text-inkSoft text-sm">看一看</View>
...
function AngleMode(deps: ModeDeps) {
  ...
  return (
    <View className="flex flex-col items-center gap-4 w-full max-w-md">
      <Hud idx={idx} score={deps.score} />
      <View className="w-full rounded-4xl bg-cream shadow-soft p-6 flex flex-col items-center gap-3">
        <View className="text-inkSoft text-sm">分一分</View>
...
function ThreeViewMode(deps: ModeDeps) {
  ...
  return (
    <View className="flex flex-col items-center gap-4 w-full max-w-md">
      <Hud idx={idx} score={deps.score} />
      <View className="w-full rounded-4xl bg-cream shadow-soft p-6 flex flex-col items-center gap-3">
        <View className="text-inkSoft text-sm">看一看，想一想</View>
        <CubeStackView columns={q.columns} />
        <View
          onClick={() => deps.tts.speakZh(q.prompt)}
          className="text-2xl font-bold text-ink font-round"
...
function MotionMode(deps: ModeDeps) {
  ...
  return (
    <View className="flex flex-col items-center gap-4 w-full max-w-md">
      <Hud idx={idx} score={deps.score} />
      <View className="w-full rounded-4xl bg-cream shadow-soft p-6 flex flex-col items-center gap-3">
        <View className="text-inkSoft text-sm">它是哪种运动？</View>
...
function LengthMode(deps: ModeDeps) {
  ...
  return (
    <View className="flex flex-col items-center gap-4 w-full max-w-md">
      <Hud idx={idx} score={deps.score} />
      <View className="w-full rounded-4xl bg-cream shadow-soft p-6 flex flex-col items-center gap-3">
        <View className="text-inkSoft text-sm">量一量</View>
        <View
          onClick={() => deps.tts.speakZh(q.prompt)}
