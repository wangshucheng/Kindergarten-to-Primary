  ...
  return (
    <div className="flex flex-col items-center gap-4 w-full max-w-md">
      ...
      <div className="w-full rounded-4xl bg-cream shadow-soft p-6 flex flex-col items-center gap-3">
        <div className="text-inkSoft text-sm">速算一下</div>
        <button
      ...
      {showTrick && (
        <div className="w-full rounded-4xl bg-cream shadow-soft p-5 flex flex-col items-center gap-1 text-center">
          <div className="text-inkSoft text-xs">✨ 速算小技巧（×{q.focusMultiplier}）</div>
          <div className="text-ink font-bold text-lg">{q.trick.trick}</div>
          <div className="text-inkSoft text-base">例 {q.trick.example}</div>
        </div>
      )}
