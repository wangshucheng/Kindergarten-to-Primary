  ...
  return (
    <div className="flex flex-col items-center gap-4 w-full max-w-md">
      ...
      <div className="w-full rounded-4xl bg-cream shadow-soft p-6 flex flex-col items-center gap-3">
        <p className="text-ink text-base leading-relaxed text-center px-2">{q.stem}</p>
        <div className="flex items-center gap-3">
          <span className="text-4xl font-bold text-ink font-round tracking-wide">{q.equation}</span>
          <span className="text-4xl font-bold text-inkSoft">= ?</span>
        </div>
        <Button
          variant="ghost"
          size="sm"
      ...
      {locked && (
        <div className="w-full rounded-4xl bg-cream shadow-soft p-4 text-center">
