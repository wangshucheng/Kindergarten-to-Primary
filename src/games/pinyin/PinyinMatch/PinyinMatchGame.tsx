...
export function PinyinMatchGame({ sound, tts, onComplete }: GameProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="flex flex-col items-center bg-white rounded-4xl shadow-soft px-8 py-4">
        <div className="text-6xl">{round.target.emoji}</div>
        <div className="text-3xl font-extrabold text-ink mt-1">{round.target.pinyin}</div>
        <div className="text-xl text-ink">{round.target.char}</div>
        <div className="text-sm text-inkSoft">{round.target.meaning}</div>
      </div>

      <div className="w-full">
        <div className="text-inkSoft text-sm mb-1">声母</div>
      ...
      <div className="w-full">
        <div className="text-inkSoft text-sm mb-1">韵母</div>
        <div className="grid grid-cols-4 gap-2">
