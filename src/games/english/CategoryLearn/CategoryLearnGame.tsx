  ...
  if (view === 'categories') {
    return (
      <div className="flex flex-col items-center gap-4">
        <div className="text-center text-ink font-bold text-lg">单词分类学习</div>
        <div className="text-inkSoft text-sm text-center">点击一个分类，开始学习</div>
        ...
        <div className="w-full grid grid-cols-3 gap-3">
          {categories.map((cat) => (
            ...
            >
              ...
              <span className="text-ink font-bold text-sm">{cat.theme}</span>
              <span className="text-inkSoft text-xs">{cat.count} 词</span>
            </button>
          ))}
        </div>
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <div className="flex items-center gap-3 w-full">
        ...
        <div className="text-ink font-bold flex-1 text-center">
      ...
      <div className="w-full grid grid-cols-2 gap-3">
        {words.map((w) => (
          ...
          >
            ...
            {w.example && (
              <span className="text-inkSoft text-[10px] text-center leading-tight mt-1">
                {w.example}
              </span>
            )}
          </button>
